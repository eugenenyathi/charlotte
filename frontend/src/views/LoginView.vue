    ...
    <section class="signin-content">
      ...
      <form @submit.prevent="handleLogin">
        <div class="signin-control">
          ...
          }" placeholder="Student Number" :value="studentNumber" @input="updateStNumber($event)" autocomplete="off" />
        </div>
        <div class="signin-control last-child">
          <BaseInput :class="{
            'signin-input': !error.password,
            'signin-input error shake': error.password
          }
            " :type="pwdInputType" placeholder="Password" autocomplete="off" v-model="password" />
          <ButtonIcon v-if="showPassword" class="eye-icon" iconName="fa-solid fa-eye" @btnFn="togglePassword" />
          <ButtonIcon v-else class="eye-icon" iconName="fa-solid fa-eye-slash" @btnFn="togglePassword" />
        </div>

        <Alert v-if="alert.show" :msg="alert.msg" :type="alert.type" />

        <!-- <router-link to="/reset_password" :class="{
