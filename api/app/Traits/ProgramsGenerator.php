...
trait ProgramsGenerator
{
    ...
    private $conPrograms = [
        ...
        [
            'id' => 'GIS',
            'program' => 'Geography & Information Systems',
            'faculty_id' => 'HUN'
        ],
        [
            'id' => 'DS',
        ...
        [
            'id' => 'LC',
            'program' => 'Language & Communication',
            'faculty_id' => 'HUN'
        ],
        [
            'id' => 'ACC',
    ...
    public function main()
    {
        ...
        /**
         * 1. Loop through each program based on the level,
         * 2. Create a program id's based on the level e.g. BC21 or AE11
         * 3. Categorize the program id's e.g. part 1 or 2 etc
         */
        ...
        foreach ($this->conPrograms as $program) {
            foreach ($this->levels as $level) {
                ...
                /**
                 * This is a rule to prevent the creation of part 5's in other programs
                 * that are not Production Engineering
                 */
